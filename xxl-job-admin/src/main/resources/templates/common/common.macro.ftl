...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>cloudpivot</b></span>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>cloudpivot-JOB</b> ${I18n.admin_version}
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
                <a href="https://www.authine.com/" target="_blank" >authine</a>
				&nbsp;
<#--                <a href="https://github.com/authine/xxl-job" target="_blank" >github</a>-->
